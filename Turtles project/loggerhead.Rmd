...
Based on the resamples of these data, we estimate males are, on average 6.3 (the point estimate) inches larger than females. If we were to repeat this experiment, we'd expect males to be between 2.82 and 9.78 inches (the confidence interval) larger than females. 
